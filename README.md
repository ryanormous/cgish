...
### BUILD NOTE:
Since this project is somewhat demonstrative, rather than production-oriented,
busybox compile dependencies are not within scope here.
Its pretty much gcc, make, and the libc development package.
